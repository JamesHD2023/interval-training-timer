...
```bash
git remote add encore encore://interval-training-timer-f7q2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/interval-training-timer-f7q2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/interval-training-timer-f7q2/settings/integrations/github)
